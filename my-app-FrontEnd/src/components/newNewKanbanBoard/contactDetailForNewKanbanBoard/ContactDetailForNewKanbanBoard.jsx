  ...
  return (
    <Box m="20px">
      <Header
        ...
        subtitle="View and manage contact information"
      />
      <Box display="flex" justifyContent="center" sx={{ marginTop: 3 }}>
        <Card sx={{ width: "100%", boxShadow: 3 }}>
          <CardContent>
            ...
            <Typography>
              Contact Name: {editableContact.contactInfo.contactName}
            </Typography>
            <Typography>Title: {editableContact.contactInfo.title}</Typography>
            <Typography>
              Mobile: {editableContact.contactInfo.mobile}
            </Typography>
            <Typography>
              Address: {editableContact.contactInfo.address}
            </Typography>
            <Typography>
              Website: {editableContact.contactInfo.website}
            </Typography>
            <Typography>
              Source: {editableContact.contactInfo.source}
            </Typography>
            <Typography>
              Referred By: {editableContact.contactInfo.referredBy}
            </Typography>
            <Typography>
              Days to Assign: {editableContact.contactInfo.daysToAssign}
            </Typography>
            <Typography>
              Days to Close: {editableContact.contactInfo.daysToClose}
            </Typography>
