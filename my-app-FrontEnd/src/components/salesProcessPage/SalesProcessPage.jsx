...
const data = [
 { step: 'First Call', painPoints: 1, desiredGains: 2, valueSearch: 3 },
 { step: 'Second Touch', gainContributors: 2, painKiller: 4, objectionHandling: 1 },
 { step: 'Follow Up', followUpResponse: 3 },
];
...
const SalesProcessDiagram = () => {
 ...
 return (
  <Box m="20px">
   <Header title="Sales Process" subtitle="Manage the sales process efficiently" />
   <Box display="flex" justifyContent="center" sx={{ marginTop: 3 }}>
    <Card sx={{ width: '100%', boxShadow: 3 }}>
     <CardContent>
      ...
      <Typography variant="h4" sx={{ fontWeight: 'bold', mb: 2, marginTop: 4 }}>
       Second Touch
      </Typography>
      <Divider sx={{ mb: 2 }} />
      ...
      <Grid container spacing={2}>
       <Grid item xs={12}>
        <Typography variant="body1" sx={{ marginBottom: 2 }}>
         ...
         after six no
         tell to them ققوله فيه فرصه نشتغل مع بعض ولا فكك مني  واكلمك السنه الجيه
       ...
       <Grid item xs={12}>
        <Typography variant="body1" sx={{ marginBottom: 2 }}>
         first
         client tell to me keep follow me
       ...
       <Grid item xs={12}>
        <Typography variant="body1" sx={{ marginBottom: 2 }}>
         second
         client tell me call me after month or year
        </Typography>
       </Grid>
