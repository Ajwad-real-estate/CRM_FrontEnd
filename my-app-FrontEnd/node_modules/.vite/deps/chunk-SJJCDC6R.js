...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon2)) context.moveTo(0, 0);
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da, da1 = da, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon2 && (padRadius ? +padRadius.apply(this, arguments) : sqrt(r0 * r0 + r1 * r1)), rc = min(abs(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t04, t14;
      if (rp > epsilon2) {
...
function ticker(year2, month2, week, day2, hour2, minute2) {
  ...
  function tickInterval(start, stop, count2) {
    ...
    if (i === 0) return millisecond2.every(Math.max(tickStep(start, stop, count2), 1));
...
//# sourceMappingURL=chunk-SJJCDC6R.js.map
