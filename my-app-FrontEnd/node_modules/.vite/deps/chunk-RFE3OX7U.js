import {
  ...
  timeFormat,
  wiggle_default
} from "./chunk-5WEZNLX2.js";
import {
  require_prop_types
} from "./chunk-LFY6ECF7.js";
import {
  require_react_dom
...
var AnimatedStyle = class extends AnimatedObject {
  constructor({ x: x3, y: y3, z: z3, ...style }) {
    const inputs = [];
    const transforms = [];
    if (x3 || y3 || z3) {
...
function Sr(e4, r3) {
  return Sr = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e5, r4) {
    return e5.__proto__ = r4, e5;
  }, Sr(e4, r3);
}
function Br(e4, r3) {
  if (null == e4) return {};
...
var Kr = function(e4) {
  if ((0, import_isFunction.default)(e4)) {
    if (!(0, import_isFunction.default)(e4.domain)) throw new Error("Provided colors should be a valid quantize scale providing a 'domain()' function");
    return e4;
  }
  if (Xr[e4]) return quantize().range(Xr[e4]);
  if ((0, import_isArray.default)(e4)) return quantize().range(e4);
...
var Lt = function(e4) {
  var t4 = e4.children, i3 = e4.theme, o3 = e4.isInteractive, l3 = void 0 === o3 || o3, d3 = e4.renderWrapper, s3 = void 0 === d3 || d3, u3 = e4.animate, c9 = e4.motionConfig, f3 = (0, import_react15.useRef)(null), m4 = V(f3), y3 = m4.actions, v4 = m4.state, _ = (0, import_react15.useCallback)(function(e5, r3) {
    return y3.showTooltipFromEvent(e5, r3);
  }, [y3.showTooltipFromEvent]), w3 = (0, import_react15.useMemo)(function() {
    return { showTooltip: l3 ? _ : Bt, hideTooltip: l3 ? y3.hideTooltip : Bt };
  }, [y3.hideTooltip, l3, _]);
  return (0, import_jsx_runtime.jsx)(Wt, { theme: i3, children: (0, import_jsx_runtime.jsx)(Ar, { animate: u3, config: c9, children: (0, import_jsx_runtime.jsx)(j.Provider, { value: y3, children: (0, import_jsx_runtime.jsx)(O.Provider, { value: v4, children: (0, import_jsx_runtime.jsxs)(Pt, { condition: s3, wrapper: (0, import_jsx_runtime.jsx)("div", { style: Gt, ref: f3 }), children: [t4(w3), l3 && (0, import_jsx_runtime.jsx)(F, {})] }) }) }) }) });
};
...
var yn = function(e4) {
  var r3 = e4.x, t4 = e4.y, n3 = e4.symbol, i3 = void 0 === n3 ? mn : n3, o3 = e4.size, l3 = e4.datum, a2 = e4.color, d3 = e4.borderWidth, u3 = e4.borderColor, c9 = e4.label, f3 = e4.labelTextAnchor, p3 = void 0 === f3 ? "middle" : f3, h2 = e4.labelYOffset, g3 = void 0 === h2 ? -12 : h2, b3 = zt(), m4 = Ur(), y3 = m4.animate, v4 = m4.config, _ = useSpring({ transform: "translate(" + r3 + ", " + t4 + ")", config: v4, immediate: !y3 });
...
var _n = function(e4) {
  var r3 = e4.width, t4 = e4.height, n3 = e4.axis, i3 = e4.scale, o3 = e4.value, l3 = e4.lineStyle, a2 = e4.textStyle, d3 = e4.legend, s3 = e4.legendPosition, u3 = void 0 === s3 ? "top-right" : s3, c9 = e4.legendOffsetX, f3 = void 0 === c9 ? 14 : c9, p3 = e4.legendOffsetY, h2 = void 0 === p3 ? 14 : p3, g3 = e4.legendOrientation, b3 = void 0 === g3 ? "horizontal" : g3, m4 = zt(), y3 = 0, v4 = 0, _ = 0, w3 = 0;
  "y" === n3 ? (_ = i3(o3), v4 = r3) : (y3 = i3(o3), w3 = t4);
  var k3 = null;
  if (d3) {
    var R = function(e5) {
  ...
  return (0, import_jsx_runtime.jsxs)("g", { transform: "translate(" + y3 + ", " + _ + ")", children: [(0, import_jsx_runtime.jsx)("line", { x1: 0, x2: v4, y1: 0, y2: w3, stroke: m4.markers.lineColor, strokeWidth: m4.markers.lineStrokeWidth, style: l3 }), k3] });
};
...
var On = function(e4) {
  return function(r3) {
    ...
    return n3 = r3, (t4 = i3).prototype = Object.create(n3.prototype), t4.prototype.constructor = t4, Sr(t4, n3), i3.prototype.render = function() {
      var r4 = this.props, t5 = r4.theme, n4 = r4.renderWrapper, i4 = r4.animate, o3 = r4.motionConfig, l3 = Br(r4, xn);
      return (0, import_jsx_runtime.jsx)(St, { theme: t5, renderWrapper: n4, isInteractive: l3.isInteractive, animate: i4, motionConfig: o3, children: (0, import_jsx_runtime.jsx)(e4, jr({}, l3)) });
    }, i3;
  }(import_react15.Component);
};
var qn = function(e4, r3) {
  var t4, n3 = (0, import_isFunction.default)(e4) ? e4 : function(r4) {
    return (0, import_get.default)(r4, e4);
  };
  return r3 && (t4 = (0, import_isFunction.default)(r3) ? r3 : format(r3)), t4 ? function(e5) {
    return t4(n3(e5));
  } : n3;
};
var Cn = function(e4) {
...
var Mn = function(e4, r3, t4, n3) {
  var i3 = t4 - e4, o3 = n3 - r3;
  return i3 *= i3, o3 *= o3, Math.sqrt(i3 + o3);
};
var Pn = function(e4, r3, t4, n3) {
  var i3 = Math.atan2(n3 - r3, t4 - e4) - Math.PI / 2;
...
var b = (0, import_react16.memo)(function(t4) {
  var o3, n3 = t4.position, r3 = t4.anchor, e4 = t4.children, l3 = zt(), d3 = Ur(), y3 = d3.animate, f3 = d3.config, b3 = kt(), g3 = b3[0], w3 = b3[1], T2 = (0, import_react16.useRef)(false), C3 = void 0, E2 = false, P2 = w3.width > 0 && w3.height > 0, j3 = Math.round(n3[0]), N2 = Math.round(n3[1]);
  P2 && ("top" === r3 ? (j3 -= w3.width / 2, N2 -= w3.height + 14) : "right" === r3 ? (j3 += 14, N2 -= w3.height / 2) : "bottom" === r3 ? (j3 -= w3.width / 2, N2 += 14) : "left" === r3 ? (j3 -= w3.width + 14, N2 -= w3.height / 2) : "center" === r3 && (j3 -= w3.width / 2, N2 -= w3.height / 2), C3 = { transform: m2(j3, N2) }, T2.current || (E2 = true), T2.current = [j3, N2]);
  var O4 = useSpring({ to: C3, config: f3, immediate: !y3 || E2 }), V2 = v2({}, x, l3.tooltip.wrapper, { transform: null != (o3 = O4.transform) ? o3 : m2(j3, N2), opacity: O4.transform ? 1 : 0 });
...
var E = (0, import_react16.memo)(function(t4) {
  var i3 = t4.x0, n3 = t4.x1, r3 = t4.y0, e4 = t4.y1, l3 = zt(), u3 = Ur(), d3 = u3.animate, y3 = u3.config, f3 = (0, import_react16.useMemo)(function() {
    return v2({}, l3.crosshair.line, { pointerEvents: "none" });
  }, [l3.crosshair.line]), x3 = useSpring({ x1: i3, x2: n3, y1: r3, y2: e4, config: y3, immediate: !d3 });
...
var X = function(i3) {
  var n3, l3, a2, d3, g3, f3, m4, v4, u3, y3, k3, x3 = i3.x, b3 = i3.y, A2 = i3.width, W2 = i3.height, z3 = i3.data, C3 = i3.direction, X2 = void 0 === C3 ? "left-to-right" : C3, Y2 = i3.justify, O4 = void 0 !== Y2 && Y2, B2 = i3.textColor, H2 = i3.background, E2 = void 0 === H2 ? "transparent" : H2, j3 = i3.opacity, L = void 0 === j3 ? 1 : j3, M2 = i3.symbolShape, F2 = void 0 === M2 ? "square" : M2, T2 = i3.symbolSize, P2 = void 0 === T2 ? 16 : T2, V2 = i3.symbolSpacing, R = void 0 === V2 ? 8 : V2, D = i3.symbolBorderWidth, q2 = void 0 === D ? 0 : D, G = i3.symbolBorderColor, I = void 0 === G ? "transparent" : G, N2 = i3.onClick, _ = i3.onMouseEnter, J = i3.onMouseLeave, K = i3.toggleSerie, Q = i3.effects, U = (0, import_react18.useState)({}), Z = U[0], $ = U[1], tt2 = zt(), et2 = (0, import_react18.useCallback)(function(t4) {
    if (Q) {
    ...
    null == _ || _(z3, t4);
  }, [_, z3, Q]), it2 = (0, import_react18.useCallback)(function(t4) {
    if (Q) {
      var e4 = Q.filter(function(t5) {
        return "hover" !== t5.on;
      }).reduce(function(t5, e5) {
    ...
    null == J || J(z3, t4);
  }, [J, z3, Q]), nt2 = S({ direction: X2, justify: O4, symbolSize: null != (n3 = Z.symbolSize) ? n3 : P2, symbolSpacing: R, width: A2, height: W2 }), ot2 = nt2.symbolX, rt2 = nt2.symbolY, lt2 = nt2.labelX, at2 = nt2.labelY, ct2 = nt2.labelAnchor, dt2 = nt2.labelAlignment, st = [N2, _, J, K].some(function(t4) {
    return void 0 !== t4;
  }), ht2 = "function" == typeof F2 ? F2 : w2[F2];
  return (0, import_jsx_runtime3.jsxs)("g", { transform: "translate(" + x3 + "," + b3 + ")", style: { opacity: null != (l3 = Z.itemOpacity) ? l3 : L }, children: [(0, import_jsx_runtime3.jsx)("rect", { width: A2, height: W2, fill: null != (a2 = Z.itemBackground) ? a2 : E2, style: { cursor: st ? "pointer" : "auto" }, onClick: function(t4) {
    null == N2 || N2(z3, t4), null == K || K(z3.id);
  }, onMouseEnter: et2, onMouseLeave: it2 }), c8.createElement(ht2, p2({ id: z3.id, x: ot2, y: rt2, size: null != (d3 = Z.symbolSize) ? d3 : P2, fill: null != (g3 = null != (f3 = z3.fill) ? f3 : z3.color) ? g3 : "black", borderWidth: null != (m4 = Z.symbolBorderWidth) ? m4 : q2, borderColor: null != (v4 = Z.symbolBorderColor) ? v4 : I }, z3.hidden ? tt2.legends.hidden.symbol : void 0)), (0, import_jsx_runtime3.jsx)("text", { textAnchor: ct2, style: p2({}, Mt(tt2.legends.text), { fill: null != (u3 = null != (y3 = null != (k3 = Z.itemTextColor) ? k3 : B2) ? y3 : tt2.legends.text.fill) ? u3 : "black", dominantBaseline: dt2, pointerEvents: "none", userSelect: "none" }, z3.hidden ? tt2.legends.hidden.text : void 0), x: lt2, y: at2, children: z3.label })] });
};
var Y = function(e4) {
  var i3 = e4.data, n3 = e4.x, o3 = e4.y, r3 = e4.direction, l3 = e4.padding, a2 = void 0 === l3 ? 0 : l3, c9 = e4.justify, d3 = e4.effects, s3 = e4.itemWidth, h2 = e4.itemHeight, g3 = e4.itemDirection, f3 = void 0 === g3 ? "left-to-right" : g3, m4 = e4.itemsSpacing, v4 = void 0 === m4 ? 0 : m4, u3 = e4.itemTextColor, p3 = e4.itemBackground, y3 = void 0 === p3 ? "transparent" : p3, k3 = e4.itemOpacity, b3 = void 0 === k3 ? 1 : k3, S2 = e4.symbolShape, A2 = e4.symbolSize, W2 = e4.symbolSpacing, z3 = e4.symbolBorderWidth, C3 = e4.symbolBorderColor, w3 = e4.onClick, Y2 = e4.onMouseEnter, O4 = e4.onMouseLeave, B2 = e4.toggleSerie, H2 = x2({ itemCount: i3.length, itemWidth: s3, itemHeight: h2, itemsSpacing: v4, direction: r3, padding: a2 }).padding, E2 = "row" === r3 ? s3 + v4 : 0, j3 = "column" === r3 ? h2 + v4 : 0;
  return (0, import_jsx_runtime3.jsx)("g", { transform: "translate(" + n3 + "," + o3 + ")", children: i3.map(function(e5, i4) {
    return (0, import_jsx_runtime3.jsx)(X, { data: e5, x: i4 * E2 + H2.left, y: i4 * j3 + H2.top, width: s3, height: h2, direction: f3, justify: c9, effects: d3, textColor: u3, background: y3, opacity: b3, symbolShape: S2, symbolSize: A2, symbolSpacing: W2, symbolBorderWidth: z3, symbolBorderColor: C3, onClick: w3, onMouseEnter: Y2, onMouseLeave: O4, toggleSerie: B2 }, i4);
  }) });
};
var O3 = function(e4) {
  var i3 = e4.data, n3 = e4.containerWidth, o3 = e4.containerHeight, r3 = e4.translateX, l3 = void 0 === r3 ? 0 : r3, a2 = e4.translateY, c9 = void 0 === a2 ? 0 : a2, d3 = e4.anchor, s3 = e4.direction, h2 = e4.padding, g3 = void 0 === h2 ? 0 : h2, f3 = e4.justify, m4 = e4.itemsSpacing, v4 = void 0 === m4 ? 0 : m4, u3 = e4.itemWidth, p3 = e4.itemHeight, y3 = e4.itemDirection, k3 = e4.itemTextColor, S2 = e4.itemBackground, A2 = e4.itemOpacity, W2 = e4.symbolShape, z3 = e4.symbolSize, C3 = e4.symbolSpacing, w3 = e4.symbolBorderWidth, X2 = e4.symbolBorderColor, O4 = e4.onClick, B2 = e4.onMouseEnter, H2 = e4.onMouseLeave, E2 = e4.toggleSerie, j3 = e4.effects, L = x2({ itemCount: i3.length, itemsSpacing: v4, itemWidth: u3, itemHeight: p3, direction: s3, padding: g3 }), M2 = L.width, F2 = L.height, T2 = b2({ anchor: d3, translateX: l3, translateY: c9, containerWidth: n3, containerHeight: o3, width: M2, height: F2 }), P2 = T2.x, V2 = T2.y;
  return (0, import_jsx_runtime3.jsx)(Y, { data: i3, x: P2, y: V2, direction: s3, padding: g3, justify: f3, effects: j3, itemsSpacing: v4, itemWidth: u3, itemHeight: p3, itemDirection: y3, itemTextColor: k3, itemBackground: S2, itemOpacity: A2, symbolShape: W2, symbolSize: z3, symbolSpacing: C3, symbolBorderWidth: w3, symbolBorderColor: X2, onClick: O4, onMouseEnter: B2, onMouseLeave: H2, toggleSerie: "boolean" == typeof E2 ? void 0 : E2 });
};
var B = { start: "left", middle: "center", end: "right" };
var H = function(t4, e4) {
  var i3 = e4.data, n3 = e4.containerWidth, o3 = e4.containerHeight, r3 = e4.translateX, l3 = void 0 === r3 ? 0 : r3, a2 = e4.translateY, c9 = void 0 === a2 ? 0 : a2, d3 = e4.anchor, s3 = e4.direction, h2 = e4.padding, g3 = void 0 === h2 ? 0 : h2, f3 = e4.justify, m4 = void 0 !== f3 && f3, v4 = e4.itemsSpacing, u3 = void 0 === v4 ? 0 : v4, p3 = e4.itemWidth, y3 = e4.itemHeight, k3 = e4.itemDirection, A2 = void 0 === k3 ? "left-to-right" : k3, W2 = e4.itemTextColor, z3 = e4.symbolSize, C3 = void 0 === z3 ? 16 : z3, w3 = e4.symbolSpacing, X2 = void 0 === w3 ? 8 : w3, Y2 = e4.theme, O4 = x2({ itemCount: i3.length, itemWidth: p3, itemHeight: y3, itemsSpacing: u3, direction: s3, padding: g3 }), H2 = O4.width, E2 = O4.height, j3 = O4.padding, L = b2({ anchor: d3, translateX: l3, translateY: c9, containerWidth: n3, containerHeight: o3, width: H2, height: E2 }), M2 = L.x, F2 = L.y, T2 = "row" === s3 ? p3 + u3 : 0, P2 = "column" === s3 ? y3 + u3 : 0;
  t4.save(), t4.translate(M2, F2), t4.font = Y2.legends.text.fontSize + "px " + (Y2.legends.text.fontFamily || "sans-serif"), i3.forEach(function(e5, i4) {
    var n4, o4, r4 = i4 * T2 + j3.left, l4 = i4 * P2 + j3.top, a3 = S({ direction: A2, justify: m4, symbolSize: C3, symbolSpacing: X2, width: p3, height: y3 }), c10 = a3.symbolX, d4 = a3.symbolY, s4 = a3.labelX, h3 = a3.labelY, g4 = a3.labelAnchor, f4 = a3.labelAlignment;
    t4.fillStyle = null != (n4 = e5.color) ? n4 : "black", t4.fillRect(r4 + c10, l4 + d4, C3, C3), t4.textAlign = B[g4], "central" === f4 && (t4.textBaseline = "middle"), t4.fillStyle = null != (o4 = null != W2 ? W2 : Y2.legends.text.fill) ? o4 : "black", t4.fillText(String(e5.label), r4 + s4, l4 + h3);
  }), t4.restore();
};
var j2 = function(t4) {
  var e4 = t4.scale, i3 = t4.domain, n3 = t4.reverse, o3 = void 0 !== n3 && n3, r3 = t4.valueFormat, l3 = void 0 === r3 ? function(t5) {
    return t5;
  } : r3, a2 = t4.separator, c9 = void 0 === a2 ? " - " : a2;
  return (0, import_react18.useMemo)(function() {
    var t5 = (null != i3 ? i3 : e4.range()).map(function(t6, i4) {
      var n4 = e4.invertExtent(t6), o4 = n4[0], r4 = n4[1];
      return { id: t6, index: i4, extent: [o4, r4], label: "" + l3(o4) + c9 + l3(r4), value: e4(o4), color: t6 };
    });
    return o3 && t5.reverse(), t5;
  }, [i3, e4, o3, c9, l3]);
};
...
//# sourceMappingURL=chunk-RFE3OX7U.js.map
